  ...
  var A1 = 'nada', A2 = 'nada', A3 = 'nada', B1 = 'nada', B2 = 'nada', B3 = 'nada', C1 = 'nada', C2 = 'nada', C3 = 'nada';
  ...
  function changeImgA1() {
    ...
    if(A1 == 'x' && A2 =='x' && A3 =='x' || A1 == 'x' && B1 == 'x' && C1 == 'x' || A1 == 'x' && B2 == 'x' && C3 == 'x' || B1 == 'x' && B2 =='x' && B3 =='x' || C1 == 'x' && C2 =='x' && C3 =='x' || A2 == 'x' && B2 == 'x' && C2 == 'x' || A3 == 'x' && B3 == 'x' && C3 == 'x' || A3 == 'x' && B2 == 'x' && C1 == 'x'){
      alert('Ganó la X');
      aux1 = 0, aux2 = 0, aux3 = 0, aux4 = 0, aux5 = 0, aux6 = 0, aux7 = 0, aux8 = 0, aux9 = 0;
    } 
    else if(A1 == 'o' && A2 =='o' && A3 =='o' || A1 == 'o' && B1 == 'o' && C1 == 'o' || A1 == 'o' && B2 == 'o' && C3 == 'o' || B1 == 'o' && B2 =='o' && B3 =='o' || C1 == 'o' && C2 =='o' && C3 =='o' || A2 == 'o' && B2 == 'o' && C2 == 'o' || A3 == 'o' && B3 == 'o' && C3 == 'o' || A3 == 'o' && B2 == 'o' && C1 == 'o') {
      alert('Ganó O');
      aux1 = 0, aux2 = 0, aux3 = 0, aux4 = 0, aux5 = 0, aux6 = 0, aux7 = 0, aux8 = 0, aux9 = 0;
    } 
    else if(A1 != 'nada' && A2 != 'nada' && A3 != 'nada' && B1 != 'nada' && B2 != 'nada' && B3 != 'nada' && C1 != 'nada' && C2 != 'nada' && C3 != 'nada'){
        alert('Empate!');
    }
  }
